...
const entrypoints = [
  { source: "../tools.ts", output: "index.js" },
  { source: "../host-bridge.ts", output: "host-bridge.js" },
  { source: "../lib.ts", output: "lib.js" },
  { source: "../generated-guidance.ts", output: "generated-guidance.js" },
];
